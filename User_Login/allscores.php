<?php
error_reporting(0);
function getallcodingprofilesscores($codechef,$codeforces,$leetcode,$interviewbit,$spoj,$geeksforgeeks){
    $codechefscore = getscore($codechef, 'codechef');
    $codeforcesscore = getscore($codeforces, 'codeforces');
    $leetcodescore = getscore($leetcode, 'leetcode');
    $interviewbitscore = getscore($interviewbit, 'interviewbit');
    $spojscore = getscore($spoj, 'spoj');
    $geeksforgeeksscore = getscore($geeksforgeeks, 'geeksforgeeks');
    $allcodingprofilesscores = array(
    ...
    return $allcodingprofilesscores;
}
$websites = array(
