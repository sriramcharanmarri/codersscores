...
<html data-bs-theme="light" lang="en">
    <head>
        ...
        <title>Codechef | CodersScores</title>
    ...
    <div class="container py-md-5">
        <div class="row">
            <div class="col-md-6 text-center">
                <img class="img-fluid w-100" src="assets/img/cc-logo.svg?h=8f49eada36838591176ea8ad1e4dab91" width="476" height="248" style="padding-bottom: 0px;margin-bottom: 0px;padding-top: 0px;margin-top: 36px;">
            </div>
            <div class="col-md-5 col-xl-4 text-center text-md-start">
                <h2 class="display-6 fw-bold mb-5"></h2>
                <form method="post" data-bs-theme="light">
                    <div class="mb-3">
                    <input class="form-control" type="text" name="uname" placeholder="codechef user name" required="">
                </div>
                <div class="mb-5">
...
if (isset($_POST["uname"])){
    ...
    $rating = toNum($html->find('.rating', 0)->plaintext);
    $cc = toNum($html->find('.contest-participated-count', 0)->plaintext);
    $content = $html->find('.content', 0);
    $ps = toNum($content->find('h3', 5)->plaintext);
    $stars=$html->find('.rating', 0)->plaintext;
    echo '<div class="container"><h4 style="text-align:center;">Hey! <b>'.$name.'</b> Alias <b>'.$username.'</b></h4>
    ...
    <table class="table table-hover">
        ...
        <tbody>
            ...
            <tr><td>No of Contests</td><td>'.$cc.'</td></tr>
            <tr><td>Total problems solved</td><td>'.$ps.'</td></tr>
        </tbody>
    </table>
</div></div>';
    } 
