    ...
    <div class="container py-md-5">
        <div class="row">
            <div class="col-md-6 text-center">
                <img class="img-fluid w-100" src="assets/img/GeeksforGeeks_logo.svg" width="476" height="248" style="padding-bottom: 0px;margin-bottom: 0px;padding-top: 0px;margin-top: 36px;">
            </div>
            <div class="col-md-5 col-xl-4 text-center text-md-start">
                <h2 class="display-6 fw-bold mb-5"></h2>
                <form method="post" data-bs-theme="light">
                    <div class="mb-3">
                    <input class="form-control" type="text" name="uname" placeholder="gfg user name" required="">
                </div>
                <div class="mb-5">
...
if (isset($_POST["uname"])){
    ...
    $rank = checkEmpty(toNum($html->find('span.profilePicSection_head_userRankContainer_rank__abngM', 0)->plaintext));
    $os = checkEmpty(toNum($html->find('div.scoreCard_head_card_left--score__pC6ZA', 0)->plaintext));
    $ps = checkEmpty(toNum($html->find('div.scoreCard_head_card__s_1Ey', 1)->plaintext));
    ...
    <table class="table table-hover">
        ...
        <tbody>
            ...
            <tr><td>Overall Score</td><td>'.$os.'</td></tr>
