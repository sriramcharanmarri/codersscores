    ...
    <div class="container py-md-5">
        <div class="row">
            <div class="col-md-6 text-center">
                <img class="img-fluid w-100" src="assets/img/Spoj-Logo.png" width="476" height="248" style="padding-bottom: 0px;margin-bottom: 0px;padding-top: 0px;margin-top: 36px;">
            </div>
            <div class="col-md-5 col-xl-4 text-center text-md-start">
                <h2 class="display-6 fw-bold mb-5"></h2>
                <form method="post" data-bs-theme="light">
                    <div class="mb-3">
                    <input class="form-control" type="text" name="uname" placeholder="Spoj user name" required="">
                </div>
                <div class="mb-5">
...
if (isset($_POST["uname"])){
    ...
    if (($h1!="Become a true programming master") || ($headers && strpos($headers[0], '200') !== false)) {
    ...
    <table class="table table-hover">
        ...
        <tbody>
            ...
            <tr><td>Number Of Submissions</td><td>'.$ns.'</td></tr>
        </tbody>
    </table>
</div></div>';
    } 
